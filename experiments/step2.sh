...
./filmstock chunk -records out -out out/passages2.jsonl.gz -sections lean -workers 12 2>&1 | tail -4
...
step "quantize"
./filmstock quantize -vectors $I2/vectors.f32.BAAI_bge-large-en-v1.5.bin -dim 1024 2>&1 | tail -3

step "score (baseline was MRR 0.602)"
./filmstock eval-vec -quant $I2/quant.BAAI_bge-large-en-v1.5.json \
