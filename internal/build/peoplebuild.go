...
func personKey(qid int64, wiki string) (string, bool) {
	...
	if wiki != "" {
		return "w:" + filmstock.Normalize(wiki), true
	}
	return "", false
}
...
func (b *peopleBuilder) person(p filmstock.Person) (int64, bool) {
...
func (b *peopleBuilder) credit(seen map[string]bool, people []filmstock.Person, workID int, workType, role string) {
