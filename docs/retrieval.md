...
Lifted out of docs/TODO.md when semantic search left main. These are the numbers
and the conclusions drawn from them; read this before re-running anything, since
several of these questions are settled and repeating them is wasted GPU time.
